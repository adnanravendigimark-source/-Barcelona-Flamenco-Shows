...
export const DEFAULT_SECTIONS: HomepageSections = {
  ...
  tower: {
    ...
    images: [
      {
        src: "/images/tablao-de-carmen.jpg",
        alt: "Passionate flamenco dancer performing at Tablao de Carmen in Barcelona",
        label: "Tablao de Carmen",
      },
      {
        src: "/images/spanish-guitar.jpg",
...
const DEFAULT_HOMEPAGE_CONTENT: HomepageContent = {
  ...
  heroCtaPrimaryText: "Explore Shows",
