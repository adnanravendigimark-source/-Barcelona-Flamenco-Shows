...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Barcelona Flamenco Show",
  metaDescription: "Privacy Policy for Barcelona Flamenco Show — how we collect, use, and protect your information.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
