      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <div className="mt-4 space-y-1.5">
          {tour.includes.slice(0, 3).map((item) => (
            <div
              key={item}
              className="flex items-start gap-2 rounded-md bg-zinc-50 px-2.5 py-1.5 text-[11.5px] text-zinc-700 border border-zinc-100"
            >
        ...
        {tour.duration && <p className="mt-2 text-xs font-medium text-stone-500">⏱ {tour.duration}</p>}
